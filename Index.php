      ...
      <div class="row" >
          ...
          <div class="card bg-primary text-white mb-4">
            ...
            <div class=' row mx-0 d-flex jusitify-content-center'>
              <div class='col-md-12 d-flex justify-content-center'>
                <label class="text-center"><?php echo $pendingCount ?>
                </label>
              </div>
            </div >
        ...
        <div class="col-xl-3 col-md-6">
          <div class="card bg-success text-white mb-4">
            ...
            <div class=' row mx-0 d-flex jusitify-content-center'>
              <div class='col-md-12 d-flex justify-content-center'>
                <label class="text-center"><?php echo $approvalCount ?>
        ...
        <div class="col-xl-3 col-md-6">
          <div class="card bg-danger text-white mb-4">
            <div class="card-body">Reject Fuel Requests</div>
            <div class=' row mx-0 d-flex jusitify-content-center'>
              <div class='col-md-12 d-flex justify-content-center'>
                <label class="text-center"><?php echo $rejectCount ?>
      ...
      <div class="row">
        <div class="col-xl-6">
          <div class="card mb-4">
            ...
            <div class="card-body"><div id="myAreaChart" width="100%" height="40"></div></div>
        ...
        <div class="col-xl-6">
          <div class="card mb-4">
            ...
            <div class="card-body"><div id="myBarChart" width="100%" height="40"></div></div>
          </div>
        </div>
      </div>
    </div>
