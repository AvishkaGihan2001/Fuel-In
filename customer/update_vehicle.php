...
<?php
   ...
   if (isset($_POST['vehicle_id'])) {
       ...
       if ($connect->connect_error) {
        ...
        $sql = "UPDATE add_vehicle set email = '$email', vehicle_no = '$vno', chasse_no = '$chano',vehicle_type = '$vehicle_type' where vehicle_id = '$vehicle_id' ";
        $sql = "UPDATE req_fuel SET status ='Approved' where full_name = 'full_name'";
